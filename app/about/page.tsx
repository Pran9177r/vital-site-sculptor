    ...
    <div className="flex flex-col w-full bg-white">
      ...
      <section className="relative py-32 md:py-44 lg:py-48 min-h-[480px] md:min-h-[560px] flex items-center justify-center border-b border-slate-100 overflow-hidden">
        ...
        <div className="mx-auto max-w-4xl px-5 text-center relative z-10 text-white">
          <Reveal>
            <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight">About Teen Harbor</h1>
          </Reveal>
          <Reveal delay={100}>
            <p className="mt-6 text-lg md:text-xl leading-relaxed text-white/95 max-w-3xl mx-auto font-medium drop-shadow">
